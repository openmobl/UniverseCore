...
#define stringPrintF   StrPrintF

extern void stringMakeInt(char *text); // This is really only for the PalmOS or other systems
                                       // without sscanf so that Variant can still work. Untested!
