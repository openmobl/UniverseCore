...
int testerNotifyCallbackPtr(LoaderCallbackPtr data, void *loader, void *dataP)
{
    switch (data->state) {
...
int testerStateChangeCallbackPtr(LoaderStateEnum newState, void *loader, void *dataP)
{
    switch (newState) {
