...
{
    SGML_EXTENSION_XML *ret = (SGML_EXTENSION_XML *)memMgrChunkNew(sizeof(SGML_EXTENSION_XML));
    SGML_HANDLERS handlers;

    if (ret)
        memMgrChunkSet(ret, 0, sizeof(SGML_EXTENSION_XML));
    ...
    handlers.cdataNew     =  sgmlExtensionXmlCDATANew;
...
void sgmlExtensionXmlElementBegin(SGML_PARSER *parser, void *userContext, const DOMString elementName)
{
    SGML_EXTENSION_XML *ext = (SGML_EXTENSION_XML *)sgmlParserGetExtensionContext(parser);
    DOM_ELEMENT *element;
...
void sgmlExtensionXmlElementEnd(SGML_PARSER *parser, void *userContext, const DOMString elementName)
{
    SGML_EXTENSION_XML *ext = (SGML_EXTENSION_XML *)sgmlParserGetExtensionContext(parser);
...
void sgmlExtensionXmlAttributeNew(SGML_PARSER *parser, void *userContext, const DOMString attributeName, const DOMString attributeValue)
{
    SGML_EXTENSION_XML *ext = (SGML_EXTENSION_XML *)sgmlParserGetExtensionContext(parser);
...
void sgmlExtensionXmlTextNew(SGML_PARSER *parser, void *userContext, const DOMString textValue)
{
    SGML_EXTENSION_XML *ext = (SGML_EXTENSION_XML *)sgmlParserGetExtensionContext(parser);
...
void sgmlExtensionXmlCommentNew(SGML_PARSER *parser, void *userContext, const DOMString comment)
{
    SGML_EXTENSION_XML *ext = (SGML_EXTENSION_XML *)sgmlParserGetExtensionContext(parser);
    DOM_COMMENT *com = domCommentNew(comment);
...
void sgmlExtensionXmlCDATANew(SGML_PARSER *parser, void *userContext, const DOMString data)
{
    SGML_EXTENSION_XML *ext = (SGML_EXTENSION_XML *)sgmlParserGetExtensionContext(parser);
